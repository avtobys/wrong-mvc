...
(function(mod) {
  ...
  function getQueryDialog(cm)  {
    ...
    return el("", null, label, " ",
              el("span", {style: "color: #666", className: "CodeMirror-search-hint"},
                 cm.phrase("(Можно использовать /regexp/ синтаксис для поиска)")));
  }
  ...
  function getDoReplaceConfirm(cm) {
    return el("", null,
              el("span", {className: "CodeMirror-search-label"}, cm.phrase("Заменить?")), " ",
  ...
  function replace(cm, all) {
    ...
    var dialogText = all ? cm.phrase("Заменить всё:") : cm.phrase("Замена:")
    ...
    dialog(cm, fragment, dialogText, query, function(query) {
      ...
      dialog(cm, getReplacementQueryDialog(cm), cm.phrase("Заменить на:"), "", function(text) {
        ...
        if (all) {
          ...
          var advance = function() {
            ...
            confirmDialog(cm, getDoReplaceConfirm(cm), cm.phrase("Заменить?"),
