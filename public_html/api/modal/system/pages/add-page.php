...
/**
 * @file
 * @brief окно добавления новой страницы
 */
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-window-maximize mr-2"></i>Добавить страницу</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body pt-2">
                <form action="<?= Wrong\Models\Actions::find(15)->request ?>">
                    ...
                    <div class="input-group input-group-sm mt-2">
                        ...
                        <input type="text" name="name" class="form-control" value="" placeholder="Название, будет тайтлом" autocomplete="off">
                    </div>
                    <div class="input-group input-group-sm mt-2">
                        <div class="input-group-prepend w-50">
                        ...
                        <select name="template_id" class="custom-select">
                            <?php
                            foreach (Wrong\Models\Templates::all_available('page', 'type') as $row) {
                    ...
                    <div class="input-group input-group-sm mt-2">
                        ...
                        <input title="Доступные каталоги: <?= implode(', ', $user->writeble_paths) ?>" type="text" name="file" class="form-control" value="/page/<?= Wrong\Rights\Group::row($user->main_group_id)->path ?>/request.php" placeholder="/page/<?= Wrong\Rights\Group::row($user->main_group_id)->path ?>/request.php" autocomplete="off" required>
                    </div>
