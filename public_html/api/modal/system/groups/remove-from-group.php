...
/**
 * @file
 * @brief окно - Массовое исключение из группы пользователей другой группы
 */
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Исключить пользователей группы <b>"<?= $row->name ?>"</b></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body pt-2">
                <form action="<?= Wrong\Models\Actions::find(52)->request ?>">
                    <input type="hidden" name="id" value="<?= $row->id ?>">
                    <div class="input-group input-group-sm">
                        <div class="input-group-prepend w-50">
                            <span class="input-group-text w-100">Из группы</span>
                        </div>
