 ...
 * 
 * <b>Доступность модели(чтение)</b> пользователю оределяется наличием группы в которых состоит пользователь в группах доступа модели, либо же одна из групп в которых состоит пользователь является владельцем модели.
 * 
 ...
 */ 
 ...
 /**
 * @page access Проверка прав доступов
 *
 ...
 * 
 * Вы можете кешировать любые сущности-переменные при помощи класса Cache.php Он работает по аналогии Memcached и нейминг используемых методов идентичен.
 ...
 * 
 * Разберем каждый метод в отдельности. Для того чтобы закешировать или вызвать из кеша любую сущность вы создаете экземпляр `new Cache()` вызывая контструктор:
 * 
 * @htmlonly
 ...
 * @endhtmlonly
 * 
 * Оба аргумента оциональны, но префикс желательно задать, он нужен для того чтобы не заморачиваться с уникальными ключами хранения. Например, вы работаете
