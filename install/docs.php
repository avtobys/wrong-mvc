 ...
 * @note
 * При использовании большого количества потоков позботьтесь о настройках сервера бд <a target="_blank" href="https://mariadb.com/docs/server/ref/mdb/system-variables/max_connections/"><b>max_connections</b></a> и <a target="_blank" href="https://mariadb.com/docs/server/ref/mdb/system-variables/max_user_connections/"><b>max_user_connections</b></a>. Настройки задач хранятся в бд и выпоняются
 * максимально короткие запросы для их получения.
 * 
