 ...
 * эффективно управлять целиком.
 * 
 * Например, у вас есть функционал "оформление заявок", который включает в себя определённые inpage(встраиваемые) шаблоны, формы/действия, модальные окна, страницы.
 * И вам нужно иметь возможность отключать и выключать целиком весь этот связанный функционал, а не по отдельности.
 * Для этого создайте группу "оформление заявок" и свяжите группы доступа всех моделей лишь с данным функционалом. И вы сможете управлять им с кнопки включения
 * и отключения группы.
 * 
