...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Действие';
...
CREATE TABLE `crontabs` (
  ...
  KEY `act` (`act`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Крон задача';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `crontabs` VALUES (1,'/api/action/toggle',1,'* * * * *','POST','[]','{\"id\":\"3\",\"table\":\"groups\"}',2,'2023-04-01 05:42:00','Включает/отключает группу модераторы каждую минуту',1),(2,'/api/action/clean-logs',1,'0 0 */1 * *','POST','[]','[]',2,'2023-04-02 00:00:00','Периодическая очистка логов',1),(3,'/api/action/erase-group',1,'0 0 * * *','POST','[]','{\"table\":\"groups\",\"id\":\"5\"}',2,'2023-04-02 00:00:00','Очистка от всех демо моделей раз в сутки',1),(4,'/api/action/anycomment',1,'0 */1 * * *','GET','[]','[]',2,'2023-04-01 06:00:00','Обновление инфы о новых комментариях и запросах в тех поддержку',1);
...
INSERT INTO `logs` VALUES (1,1,'/api/action/toggle','{\n    \"method\": \"POST\",\n    \"input\": {\n        \"id\": \"3\",\n        \"table\": \"groups\"\n    },\n    \"output\": {\n        \"id\": 3,\n        \"act\": 0,\n        \"table\": \"groups\",\n        \"message\": \"Функционал отключен. Группа - владелец <b>Администраторы [2]<\\/b> по прежнему имеет доступ\"\n    }\n}','2023-04-01 05:41:00','127.0.0.1');
...
CREATE TABLE `modals` (
  ...
  KEY `owner_group_2` (`owner_group`,`groups`(5)),
  FULLTEXT KEY `groups` (`groups`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Модальное окно';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `selects` (
  ...
  KEY `owner_group_2` (`owner_group`,`groups`(5)),
  FULLTEXT KEY `groups` (`groups`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Выборка';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `settings` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Настройки';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-01  5:41:16
