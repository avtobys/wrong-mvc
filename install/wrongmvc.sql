...
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Действие';
...
INSERT INTO `crontabs` VALUES (1,NULL,NULL,'/api/action/toggle',1,'* * * * *','POST','[]','{\"id\":\"3\",\"table\":\"groups\"}',2,'2023-04-26 16:23:00','Включает/отключает группу модераторы каждую минуту',1),(2,NULL,NULL,'/api/action/clean-logs',1,'0 0 */1 * *','POST','[]','[]',2,'2023-04-27 00:00:00','Периодическая очистка логов',1),(3,NULL,NULL,'/api/action/erase-group',1,'0 0 * * *','POST','[]','{\"table\":\"groups\",\"id\":\"5\"}',2,'2023-04-27 00:00:00','Очистка от всех демо моделей раз в сутки',1),(4,NULL,NULL,'/api/action/anycomment',1,'0 */1 * * *','GET','[]','[]',2,'2023-04-26 17:00:00','Обновление инфы о новых комментариях и запросах в тех поддержку',1),(5,'{\"min\":5,\"max\":5,\"load\":40,\"fixed\":1}','sleep 15','',0,'* * * * *','CLI','null','[]',2,'2023-04-26 16:23:00','Перманентно спит по 15 сек в 5 потоков одновременно, а если нагрузка более 40% даже не начинает спать',1);
...
CREATE TABLE `modals` (
  ...
  KEY `owner_group_2` (`owner_group`,`groups`(5)),
  FULLTEXT KEY `groups` (`groups`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Модальное окно';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pages` (
  ...
  `note` text DEFAULT NULL COMMENT 'комментарий',
  `cache_time` int(11) unsigned NOT NULL DEFAULT 0 COMMENT 'время кеширования',
  `act` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1 - если включено, 0 - отключено полностью',
  PRIMARY KEY (`id`),
  KEY `request` (`request`) USING BTREE,
  KEY `owner_group` (`owner_group`),
...
INSERT INTO `pages` VALUES (1,'/','/page/system/main-guest.php','[0,2,3,4,5,6]',1,1,'WRONG MVC - система для создания систем','Главная для не авторизованных',0,1),(2,'/system','/page/system/main.php','[2,5]',1,2,'Панель администратора','Главная панели администратора',0,1),(3,'/system/modals','/page/system/modals.php','[2,5]',1,2,'Модальные окна','Модальные окна',0,1),(4,'/system/actions','/page/system/actions.php','[2,5]',1,2,'Действия','Действия',0,1),(5,'/system/selects','/page/system/selects.php','[2,5]',1,2,'Выборки','Выборки',0,1),(6,'/system/pages','/page/system/pages.php','[2,5]',1,2,'Страницы','Страницы',0,1),(7,'/system/templates','/page/system/templates.php','[2,5]',1,2,'Шаблоны','Шаблоны страниц и модальных окон',0,1),(8,'/system/users','/page/system/users.php','[2,5]',1,2,'Пользователи','Пользователи',0,1),(9,'/system/groups','/page/system/groups.php','[2,5]',1,2,'Группы','Группы',0,1),(10,'/system/crontabs','/page/system/crontabs.php','[2,5]',1,2,'Задачи','Задачи',0,1),(11,'/system/logs','/page/system/logs.php','[2,5]',1,2,'Логи действий','Логи действий',0,1),(12,'/disabled','/page/system/disabled.php','[0,2,3,4,5,6]',1,3,'Пользователь отключен','Страница пользователь отключен, код 403',0,1),(13,'/documentation','/page/system/main.php','[0,2,3,4,5,6]',1,1,'Документация, установка wrong-mvc','Страница документации',0,1),(14,'/forbidden','/page/system/forbidden.php','[0,2,3,4,5,6]',1,3,'Доступ запрещён!','Страница - доступ запрещен, код 403. Если request существует, но недостаточно прав',0,1),(15,'/enter','/page/system/enter.php','[0]',1,1,'Вход в систему','Страница с автоматическим вызовом формы входа',0,1),(16,'/comments','/page/system/comments.php','[0,2,3,4,5,6]',1,1,'Отзывы о системе Wrong MVC','Страница с отзывами и комментариями, плагин',0,1),(17,'/examples/tivo/index','/page/examples/tivo/main.php','[0,2,3,4,5,6]',6,11,'Tivo - Landing Page','',0,1),(18,'/examples/tivo/article','/page/examples/tivo/article-details.php','[0,2,3,4,5,6]',6,11,'Tivo - Longer Project Title Should Definitely Go Here','',0,1),(19,'/examples/tivo/terms','/page/examples/tivo/terms-conditions.php','[0,2,3,4,5,6]',6,11,'Tivo - Terms &amp; Conditions','',0,1),(20,'/examples/tivo/privacy','/page/examples/tivo/privacy-policy.php','[0,2,3,4,5,6]',6,11,'Tivo - Privacy Policy','',0,1),(21,'/examples/tivo/log-in','/page/examples/tivo/log-in.php','[0,2,3,4,5,6]',6,11,'Tivo - Log In','',0,1),(22,'/examples/tivo/sign-up','/page/examples/tivo/sign-up.php','[0,2,3,4,5,6]',6,11,'Tivo - Sign Up','',0,1),(23,'/examples/seogram/index','/page/examples/seogram/main.php','[0,2,3,4,5,6]',6,12,'Seogram - The number #1 SEO Service Company','',0,1),(24,'/examples/seogram/about','/page/examples/seogram/about.php','[0,2,3,4,5,6]',6,12,'Seogram - About Us','',0,1),(25,'/examples/seogram/service','/page/examples/seogram/service.php','[0,2,3,4,5,6]',6,12,'Seogram - Our Services','',0,1),(26,'/examples/seogram/blog','/page/examples/seogram/blog.php','[0,2,3,4,5,6]',6,12,'Seogram - Blog','',0,1),(27,'/examples/seogram/contact','/page/examples/seogram/contact.php','[0,2,3,4,5,6]',6,12,'Seogram - Contact Us','',0,1),(28,'/examples/seogram/blog-details','/page/examples/seogram/blog-details.php','[0,2,3,4,5,6]',6,12,'Seogram - Blog Details','',0,1),(29,'/examples/delfood/index','/page/examples/delfood/main.php','[0,2,3,4,5,6]',6,13,'Delfood','',0,1),(30,'/examples/delfood/about','/page/examples/delfood/about.php','[0,2,3,4,5,6]',6,13,'Delfood - About Us','',0,1),(31,'/examples/delfood/blog','/page/examples/delfood/blog.php','[0,2,3,4,5,6]',6,13,'Delfood - Latest Blog','',0,1),(32,'/examples/delfood/testimonial','/page/examples/delfood/testimonial.php','[0,2,3,4,5,6]',6,13,'Delfood - Testimonial','',0,1),(33,'/examples/marshmallow/index','/page/examples/marshmallow/main.php','[0,2,3,4,5,6]',6,14,'Marshmallow - Landing Page','',0,1),(34,'/examples/orthoc/index','/page/examples/orthoc/main.php','[0,2,3,4,5,6]',6,15,'Orthoc','',0,1),(35,'/examples/orthoc/about','/page/examples/orthoc/about.php','[0,2,3,4,5,6]',6,15,'ABOUT US','',0,1),(36,'/examples/orthoc/departments','/page/examples/orthoc/departments.php','[0,2,3,4,5,6]',6,15,'OUR DEPARTMENTS','',0,1),(37,'/examples/orthoc/doctors','/page/examples/orthoc/doctors.php','[0,2,3,4,5,6]',6,15,'OUR DOCTORS','',0,1),(38,'/examples/orthoc/contact','/page/examples/orthoc/contact.php','[0,2,3,4,5,6]',6,15,'GET IN TOUCH','',0,1),(39,'/examples/eclipse-master/index','/page/examples/eclipse-master/main.php','[0,2,3,4,5,6]',6,16,'Eclipse Education','',0,1),(40,'/examples/eclipse-master/about','/page/examples/eclipse-master/about.php','[0,2,3,4,5,6]',6,16,'About Us','',0,1),(41,'/examples/eclipse-master/courses','/page/examples/eclipse-master/courses.php','[0,2,3,4,5,6]',6,16,'Courses','',0,1),(42,'/examples/eclipse-master/elements','/page/examples/eclipse-master/elements.php','[0,2,3,4,5,6]',6,16,'Elements','',0,1),(43,'/examples/eclipse-master/course-details','/page/examples/eclipse-master/course-details.php','[0,2,3,4,5,6]',6,16,'Course Details','',0,1),(44,'/examples/eclipse-master/blog-home','/page/examples/eclipse-master/blog-home.php','[0,2,3,4,5,6]',6,16,'Blog Home','',0,1),(45,'/examples/eclipse-master/blog-single','/page/examples/eclipse-master/blog-single.php','[0,2,3,4,5,6]',6,16,'Single Blog','',0,1),(46,'/examples/eclipse-master/contacts','/page/examples/eclipse-master/contacts.php','[0,2,3,4,5,6]',6,16,'Contacts','',0,1),(47,'/examples/aesthetic-master/index','/page/examples/aesthetic-master/main.php','[0,2,3,4,5,6]',6,17,'AESTHETIC','',0,1),(48,'/examples/aesthetic-master/about','/page/examples/aesthetic-master/about.php','[0,2,3,4,5,6]',6,17,'ABOUT US','',0,1),(49,'/examples/aesthetic-master/services','/page/examples/aesthetic-master/services.php','[0,2,3,4,5,6]',6,17,'OUR SERVICES','',0,1),(50,'/examples/aesthetic-master/pricing','/page/examples/aesthetic-master/pricing.php','[0,2,3,4,5,6]',6,17,'OUR PRICES','',0,1),(51,'/examples/aesthetic-master/doctor','/page/examples/aesthetic-master/doctor.php','[0,2,3,4,5,6]',6,17,'OUR TEAM','',0,1),(52,'/examples/aesthetic-master/blog-details','/page/examples/aesthetic-master/blog-details.php','[0,2,3,4,5,6]',6,17,'NEWS DETAILS','',0,1),(53,'/examples/aesthetic-master/blog','/page/examples/aesthetic-master/blog.php','[0,2,3,4,5,6]',6,17,'NEWS','',0,1),(54,'/examples/aesthetic-master/contact','/page/examples/aesthetic-master/contact.php','[0,2,3,4,5,6]',6,17,'CONTACT US','',0,1);
...
INSERT INTO `selects` VALUES (1,'/api/select/modals','/api/select/system/modals.php','[2,5]',1,'Модальные окна',0,1),(2,'/api/select/actions','/api/select/system/actions.php','[2,5]',1,'Действия',0,1),(3,'/api/select/selects','/api/select/system/selects.php','[2,5]',1,'Выборки',0,1),(4,'/api/select/pages','/api/select/system/pages.php','[2,5]',1,'Страницы',0,1),(5,'/api/select/templates','/api/select/system/templates.php','[2,5]',1,'Шаблоны',0,1),(6,'/api/select/groups','/api/select/system/groups.php','[2,5]',1,'Группы',0,1),(7,'/api/select/users','/api/select/system/users.php','[2,5]',1,'Пользователи',0,1),(8,'/api/select/logs','/api/select/system/logs.php','[2,5]',1,'Логи действий',0,1),(9,'/api/select/crontabs','/api/select/system/crontabs.php','[2,5]',1,'Cron задачи',0,1),(10,'/api/select/cache-size','/api/select/system/cache-size.php','[2,5]',1,'Размер каталога с кешем',0,1);
...
CREATE TABLE `templates` (
  ...
  `type` enum('page','modal','incode','action','select') NOT NULL DEFAULT 'page' COMMENT 'тип шаблона',
  `note` text DEFAULT NULL COMMENT 'комментарий',
  `cache_time` int(11) unsigned NOT NULL DEFAULT 0 COMMENT 'время кеширования',
  ...
  KEY `owner_group_2` (`owner_group`,`groups`(5)),
  FULLTEXT KEY `groups` (`groups`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Шаблон страницы';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `templates` VALUES (1,'/../templates/page/system/quest.php','[0,2,3,4,5,6]',1,'Главная / гости','page','Главная для не авторизованных',0,1),(2,'/../templates/page/system/system-admin.php','[2,5]',1,'Главная / администратор системы','page','Главная для администраторов',0,1),(3,'/../templates/page/system/empty.php','[0,2,3,4,5,6]',1,'Пустая страница','page','Пустая страница',0,1),(4,'/../templates/modal/system/empty.php','[0,2,3,4,5,6]',1,'Пустое окно','modal','Пустое окно',0,1),(5,'/../templates/modal/system/form.php','[0,2,3,4,5,6]',1,'Окно с формой','modal','Окно с формой',0,1),(6,'/../templates/modal/system/buttons.php','[0,2,3,4,5,6]',1,'Окно с кнопками','modal','Окно с кнопками',0,1),(7,'/../templates/modal/system/full.php','[0,2,3,4,5,6]',1,'Окно на весь экран','modal','Окно на весь экран',0,1),(8,'/../templates/action/system/empty.php','[0,2,3,4,5,6]',1,'Пустое действие','action','Пустое действие',0,1),(9,'/../templates/select/system/empty.php','[0,2,3,4,5,6]',1,'Пустая выборка','select','Пустая выборка',0,1),(10,'/../templates/incode/system/empty.php','[0,2,3,4,5,6]',1,'Пустой incode','incode','Пустой incode',0,1),(11,'/../templates/page/examples/tivo.php','[0,2,3,4,5,6]',6,'tivo-1.0.0','page','tivo-1.0.0',0,1),(12,'/../templates/page/examples/seogram.php','[0,2,3,4,5,6]',6,'seogram-1.0.0','page','seogram-1.0.0',0,1),(13,'/../templates/page/examples/delfood.php','[0,2,3,4,5,6]',6,'delfood-1.0.0','page','delfood-1.0.0',0,1),(14,'/../templates/page/examples/marshmallow.php','[0,2,3,4,5,6]',6,'marshmallow','page','marshmallow',0,1),(15,'/../templates/page/examples/orthoc.php','[0,2,3,4,5,6]',6,'orthoc','page','orthoc',0,1),(16,'/../templates/page/examples/eclipse-master.php','[0,2,3,4,5,6]',6,'eclipse-master','page','eclipse-master',0,1),(17,'/../templates/page/examples/aesthetic-master.php','[0,2,3,4,5,6]',6,'aesthetic-master','page','aesthetic-master',0,1);
...
-- Dump completed on 2023-04-26 16:23:01
