...
INSERT INTO `crontabs` VALUES (1,'/api/action/toggle',1,'* * * * *','POST','[]','{\"id\":\"3\",\"table\":\"groups\"}',2,'2023-03-31 08:36:00','Включает/отключает группу модераторы каждую минуту',1),(2,'/api/action/clean-logs',1,'0 0 */5 * *','POST','[]','[]',2,'2023-04-05 00:00:00','Периодическая очистка логов',1),(3,'/api/action/erase-group',1,'0 0 * * *','POST','[]','{\"table\":\"groups\",\"id\":\"5\"}',2,'2023-04-01 00:00:00','Очистка от всех демо моделей раз в сутки',1),(4,'/api/action/anycomment',1,'0 */8 * * *','GET','[]','[]',2,'2023-03-31 16:00:00','Обновление инфы о новых комментариях и запросах в тех поддержку',1);
...
-- Dump completed on 2023-03-31  8:35:48
