                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="./course-details">Course Details</a>
                            </div>
                        </li>
                        <li class="dropdown">
                            <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="./blog-home">Blog Home</a>
                                <a class="dropdown-item" href="./blog-single">Blog Details</a>
                            </div>
                        </li>
