...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="./article">DETAILS</a>
                    </li>

                    <!-- Dropdown Menu -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle page-scroll" href="" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">VIDEO</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="./article"><span class="item-text">ARTICLE DETAILS</span></a>
                    ...
                    <li class="nav-item">
                        <a data-visible-page="<?= Wrong\Models\Pages::find(17)->request ?>" class="nav-link page-scroll" href="#pricing">PRICING</a>
                    </li>
                </ul>
                <span class="nav-item">
                    ...
                    <div class="footer-col middle">
                        ...
                        <ul class="list-unstyled li-space-lg p-small">
                            <li class="media">
                                ...
                                <div class="media-body">Our business partners <a class="white" href="">example.com</a></div>
                            </li>
                            <li class="media">
                                <i class="fas fa-square"></i>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © 2020 <a href="">Template by Inovatik</a><br>
